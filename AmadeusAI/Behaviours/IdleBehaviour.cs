...
using ResponseTuple =
    System.Tuple<System.Collections.Generic.List<AmadeusAI.Expression[]>, System.Func<bool>, System.TimeSpan,
        System.DateTime>;
...
namespace AmadeusAI.Behaviours
{
    ...
    {
        private readonly CSVParse parser = new CSVParse();
        ...
        private readonly List<KeyValuePair<string, (int, int)>> timeoutSpeeds =
            new List<KeyValuePair<string, (int, int)>>
            {
                ...
                // more values may be added whenever
            };
        ...
        public void Init(MainWindow window)
        {
            ...
            catch (Exception ex)
            {
                MessageBox.Show(window,
                    "An error occured: " + ex.Message + "\r\n\r\n(Try running AmadeusAI as an administrator.)");
            }
        }
        ...
        public void Update(MainWindow window)
        {
            ...
            if (AmadeusAISettings.Default.IdleWait.ToLower() == "off")
            {
                return;
            }
        ...
        {
            var speed = this.timeoutSpeeds.FirstOrDefault(x => x.Key.Contains(AmadeusAISettings.Default.IdleWait.ToLower()));
        ...
        private void PopulateResponseTable(List<amareresponse> characterResponses)
        {
