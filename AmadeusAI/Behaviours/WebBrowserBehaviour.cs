...
using ResponseTuple = System.Tuple<System.Collections.Generic.List<AmadeusAI.Expression[]>, System.DateTime>;
...
namespace AmadeusAI.Behaviours
{
    ...
    public class WebBrowserBehaviour : IBehaviour
    {
        ...
        private void PopulateResponseTable(IEnumerable<amareresponse> characterResponses)
        {
        ...
        private void PopulateGoogleResponseTable(IEnumerable<amareresponse> characterResponses)
        {
            foreach (var response in characterResponses)
            {
        ...
        public void Update(MainWindow window)
        {
            ...
            if (this.executionCounter < WebBrowserBehaviour.EXECUTION_LIMIT * (AmadeusAISettings.Default.PotatoPC ? 4 : 1)) //if pc is shit
            {
                return;
            }
